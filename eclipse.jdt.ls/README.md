...
```bash
CLIENT_PORT=5036 CLIENT_HOST=127.0.0.1 java -Declipse.application=org.eclipse.jdt.ls.core.id1 -Dosgi.bundles.defaultStartLevel=4 -Declipse.product=org.eclipse.jdt.ls.core.product -Dlog.level=ALL -Dosgi.dev -Dsocket.stream.debug=true -Xmx1G --add-modules=ALL-SYSTEM --add-opens java.base/java.util=ALL-UNNAMED -jar ./plugins/org.eclipse.equinox.launcher_1.6.500.v20230717-2134.jar -configuration ./config_mac -data /Users/arthur/Library/Mobile Documents/com~apple~CloudDocs/Documents/ESEO/Cours-i3/S9/PFE/WebCube/LSP-DATA
```
