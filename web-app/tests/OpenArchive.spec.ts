...
test('Open WebCube archive', async ({ page }) => {
    ...
    await page.locator('#Archive path').click();

    // const fileChooserPromise = page.waitForEvent('filechooser');

    await page.getByRole('button', { name: 'Open WebCube Archive' }).click();
    // const fileChooser = await fileChooserPromise;

    // Set the file to upload. Replace 'path/to/your-archive.wc' with the path to your mock .wc file
    // await fileChooser.setFiles('/Users/arthur/Downloads/TP-TEST.wc');
